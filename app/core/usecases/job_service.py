...
class JobService:
    def __init__(self):
        ...
        self.glue_context = None #GlueContext(self.spark_context)
        ...
        self.spark = None #self.glue_context.spark_session
        self.job = None #Job(self.glue_context)
    ...
    def processar_job(self):
        ...
        data_frame = spark.read.csv("C:/Users/joaop/PycharmProjects/Glue/massas/massa1.txt")
